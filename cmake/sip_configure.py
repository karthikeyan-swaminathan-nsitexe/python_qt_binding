...
if len(sys.argv) != 10:
    print('usage: %s build-dir sip-file output_dir include_dirs libs lib_dirs ldflags cc cxx' %
          sys.argv[0])
    sys.exit(1)
